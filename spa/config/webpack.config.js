...
module.exports = function (webpackEnv) {
  ...
  return {
    ...
    resolve: {
      // Fallbacks to install: https://github.com/browserify/browserify#compatibility
      fallback: {
      ...
      rules: [
        ...
        },
        {
          ...
          oneOf: [
            ...
            {
              test: require.resolve('copy-anything'),
            ...
            {
              test: require.resolve('is-what'),
              loader: 'exports-loader',
              options: {
                type: 'commonjs',
                exports: ['isArray', 'isPlainObject'],
              },
            },
